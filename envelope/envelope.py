...
class Envelope(MOPolicy, MOAgent):
    ...
    def train(
            ...
            self.register_additional_config(
                {
                    ...
                    "train_weights": train_weights.tolist() if train_weights is not None else None,
                    "eval_weights": eval_weights.tolist() if eval_weights is not None else None,
        ...
        if self.train_weights is not None:
            weight_index = 0
            w = self.train_weights[weight_index]
        else:
