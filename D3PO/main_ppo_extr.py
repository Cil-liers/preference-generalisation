...
# Set up agent
    ...
    # Example:  
    # train_weights = torch.tensor(np.array(get_ex_weights("easy_extrapolation_train_weights_10.txt")), dtype=torch.float32)
    ...
    train_weights = torch.tensor(np.array(get_ex_weights("file_one.txt")), dtype=torch.float32)
